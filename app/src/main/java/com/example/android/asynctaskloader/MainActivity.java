...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String QUERY_URL_KEY_ = "queryUrl";

    // TODO (2) Create a static final key to store the search's raw JSON
    private static final String SEARCH_RAW_JSON_KEY = "searchRawJson";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null){
            String queryUrl = savedInstanceState.getString(QUERY_URL_KEY_);
            mUrlDisplayTextView.setText(queryUrl);

            String searchResult = savedInstanceState.getString(SEARCH_RAW_JSON_KEY);
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(QUERY_URL_KEY_,urlText);

        String jsonSearchResults = mSearchResultsTextView.getText().toString();
        outState.putString(SEARCH_RAW_JSON_KEY, jsonSearchResults);
    }
